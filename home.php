...
<html>
  ...
  <body>
    ...
    <div class="content">
	  ...
	  <h4 class="humidityColor1"><i class="fas fa-tint"></i> HUMIDADE DO SOLO</h4>
          <p class="humidityColor1"><span class="reading"><span id="ESP32_01_Soil_Humd"></span> &percnt;</span></p>
	  
          <h4 class="temperatureColor"><i class="fas fa-thermometer-half"></i> TEMPERATURA AMBIENTE</h4>
          <p class="temperatureColor"><span class="reading"><span id="ESP32_01_Temp"></span> &deg;C</span></p>
          <h4 class="humidityColor"><i class="fas fa-tint"></i> HUMIDADE DO AR</h4>
          <p class="humidityColor"><span class="reading"><span id="ESP32_01_Humd"></span> &percnt;</span></p>
          
          <p class="statusreadColor"><span><?php  echo utf8_encode("Situação de envio")?>: </span><span id="ESP32_01_Status_Read_DHT11"></span></p>
        </div>
        <!-- ======================================================================================================= -->
  ...
  <h4 class="LEDColor"><i class="fas fa-lightbulb"></i> <?php  echo utf8_encode("CONTROLE MANUAL DE IRRIGAÇÃO")?>: </h4>
  <label class="switch">
    <input type="checkbox" id="ESP32_01_TogLED_01" onclick="GetTogBtnLEDState('ESP32_01_TogLED_01', 'ESP32_01_TogLED_02')">
    <div class="sliderTS"></div>
  </label>
  <h4 class="LEDColor"><i class="fas fa-lightbulb"></i> <?php  echo utf8_encode("CONTROLE AUTOMATICO DE IRRIGAÇÃO")?>:</h4>
  <label class="switch">
    ...
    <div class="content">
      <div class="cards">
        <div class="card header" style="border-radius: 15px;">
            <h3 style="font-size: 0.7rem;"><?php  echo utf8_encode("DADOS RECEBIDOS DA ÚLTIMA VEZ DO ESP32")?> [ <span id="ESP32_01_LTRD"></span> ]</h3>
            <button onclick="window.open('recordtable.php', '_blank');">Abrir Tabela de Registro</button>
