    ...
    <div class="w-full md:w-1/2 xl:w-1/3 p-6">
        <div class="bg-white border-transparent rounded-lg shadow-xl">
            <div class="bg-green-500 uppercase text-white border-b-2 border-green-600 rounded-tl-lg rounded-tr-lg p-2">
                <h5 class="font-bold uppercase"><?php echo utf8_encode("Gráfico Temperatura do Ambiente")?></h5>
            </div>
            <div class="p-5">
...
?>
    ...
    <div class="bg-white border-transparent rounded-lg shadow-xl">
        <div class="bg-green-500 uppercase text-white border-b-2 border-green-600 rounded-tl-lg rounded-tr-lg p-2">
            <h5 class="font-bold uppercase"><?php echo utf8_encode("Gráfico Umidade Relativa do Ar")?></h5>
        </div>
        <div class="p-5">
...
?>             
    ...
    <div class="bg-white border-transparent rounded-lg shadow-xl">
        <div class="bg-green-500 uppercase text-white border-b-2 border-green-600 rounded-tl-lg rounded-tr-lg p-2">
            <h5 class="font-bold uppercase"><?php echo utf8_encode("Gráfico Umidade do Solo")?></h5>
        </div>
        <div class="p-5">
